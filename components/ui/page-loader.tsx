...
export function PageLoader({
  ...
  return (
    ...
    >
      <div className="editorial-card w-full max-w-md rounded-3xl px-8 py-10 text-center animate-fade-in">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-red-600 text-white shadow-lg shadow-red-600/25 animate-soft-pulse">
          <svg
            aria-hidden="true"
            className="h-8 w-8"
            fill="currentColor"
        ...
        <p aria-live="polite" className="mt-1.5 text-[color:var(--color-text-muted)] text-sm">
          {detail}
        </p>
