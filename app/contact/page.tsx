        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {contacts.map((contact) => {
            ...
            return (
              ...
              >
                <div className="flex size-11 items-center justify-center rounded-xl bg-red-50 text-red-500 transition-colors duration-150 group-hover:bg-red-100 group-hover:text-red-600">
                  {contact.icon}
                </div>
                <div>
